 ...
 * @author Jameson
 */
public class PrintBrowserFXMLController implements Initializable {
...
//      str = str.replace("<tr", "<tr bgcolor=\"#000000\"");
    ...
    webEngine.loadContent(printHtml);
  }
...
//    job.showPageSetupDialog(stage.getOwner());
    
    if (job.showPageSetupDialog(stage.getOwner())) {
  ...
  @FXML
  private void printWebView(ActionEvent event) {
    print();
  }
